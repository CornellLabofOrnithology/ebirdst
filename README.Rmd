...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/mstrimas/ebirdst?branch=master&svg=true)](https://ci.appveyor.com/project/mstrimas/ebirdst)
