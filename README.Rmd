...
The current version of `ebirdst` is designed for working with the eBird Status and Trends data products released in December 2020, with abundance estimates made for 2019. **Users are strongly discouraged from comparing Status and Trends results between years due to methodological differences between versions.** To request access to previous versions, please contact ebird@cornell.edu.
