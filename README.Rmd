...
```
 ...
 Older versions of the Status and Trends data can be accessed by installing the associated version of `ebirdst` from GitHub. For example, the 2018 data, corresponding to v0.1.0 of this package, can be accessed by installing:
