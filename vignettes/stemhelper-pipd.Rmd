...
# 8. Predictive Performance Metrics (PPMs)
```{r load_ppms}

# may want to hide these internally
ppms <- compute_ppms(sp_path, ne_extent)

plot_binary_by_time(sp_path, metric = "Kappa", n_time_periods = 12)
