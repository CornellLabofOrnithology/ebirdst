...
- CHANGED: Stixels are now allowed to recurse one size smaller, to approximately 90km on a side.
- CHANGED: There is now a separate AdaSTEM partitioning for residents that uses the full year of data instead of a 28 day window. The training data for these partitions are also grid sampled before definition. The stixel parameters are are to allow 65,000 checklists per stixel…
...
- CHANGED: SRTM15+ [~250m elevation and bathymetry](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2019EA000658) replaces the ~1 kilometer SRTM30+ elevation and bathymetry product.
