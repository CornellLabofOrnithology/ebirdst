...
raster_path <- "/results/tifs/presentation/abundance_umean/"
tif_path <- paste(root_path, species, raster_path, sep = "")
...
occ_path <- paste(root_path, species, 
                  "/results/tifs/presentation/occurrence_umean/", sep = "")
...
pos_es_path <- paste(root_path, 
                     species, 
                     "/results/tifs/presentation/abundance_ensemble_support", 
                     sep = "")
...
lower_path <- paste(root_path, species, 
                    "/results/tifs/presentation/abundance_lower", sep = "")
lower_stack <- stack_stem(lower_path)

upper_path <- paste(root_path, species, 
                    "/results/tifs/presentation/abundance_upper", sep = "")
