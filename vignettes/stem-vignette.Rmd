...
1. Background
2. Projections, Loading Raster, Conversion
...
```{r map_centroids, cache=TRUE, warning=FALSE, messages=FALSE}
...
```{r cake_plots, cache=TRUE, message=FALSE, warning=FALSE}

# this requires a fair amount of computation
