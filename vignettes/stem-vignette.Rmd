...
knitr::opts_chunk$set(out.width="\\textwidth", fig.height=4, 
...
```{r trajectories_region, warnings=FALSE}
...
```{r map_centroids, warning=FALSE, messages=FALSE}
...
```{r cake_plots, message=FALSE, warning=FALSE}
