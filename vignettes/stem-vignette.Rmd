...
# need to select countries from naturalearthdata before 
# projecting to mollweide
library(rnaturalearthdata)

countries110_prj <- sp::spTransform(countries110,
                                    sp::CRS(sp::proj4string(template_raster)))
e <- as(sp_ext, "SpatialPolygons")
sp::proj4string(e) <- sp::CRS(sp::proj4string(template_raster))
wh <- countries110_prj[!is.na(sp::over(countries110_prj, e)),]
...
states50prj <- sp::spTransform(states50, sp::CRS(sp::proj4string(template_raster)))
wv <- states50prj[states50prj@data$name == "West Virginia",]
