...
To comapre, we first scale the colors linearly, based on the maximum from the entire year. 
...
```{r plot_es, cache=TRUE, eval=FALSE}
...
```{r plot_confidence, cache=TRUE, eval=FALSE}
