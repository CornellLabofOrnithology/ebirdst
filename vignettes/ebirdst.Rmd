---
title: "Get Started with eBird Status & Trends Data"
author: "Tom Auer, Daniel Fink"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteEncoding{UTF-8}
  %\VignetteIndexEntry{Get Started with eBird Status & Trends Data}
...
3. [Species List](#species-list)
4. [Data Types and Structure](#data-types-and-structure)
