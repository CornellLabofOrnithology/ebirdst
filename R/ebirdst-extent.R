...
from_srd_date <- function(x) {
  ...
  d2016 <- as.Date(format(d2015, format = "2016-%m-%d"), format = "%Y-%m-%d")
  # fix end dates
  d2016 <- dplyr::if_else(x == 0, as.Date("2016-01-01"), d2016)
  d2016 <- dplyr::if_else(x == 1,  as.Date("2016-12-31"), d2016)
  return(d2016)
}
